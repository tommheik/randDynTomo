function [ A ] = create_blkdiag_ct_operator_2d_fan_astra_cpu( CtData, xDim, yDim, angles )
% CREATE_BLKDIAG_CT_OPERATOR_2D_FAN_ASTRA_CPU Create 2D CT forward model
% in block diagonal format.
%   A = create_blkdiag_ct_operator_2d_fan_astra_cpu( ctData, xDim, yDim ) computes the 
...
% This implementation works with v1 and v2 of HelTomo
...
for i = 1:numOps
    ...
    Alist{i} = opTomo('strip_fanflat', projectionGeometry, volumeGeometry);
end
